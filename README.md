...
<p align="center">
   ...
   <a href="https://github.com/denoland/deno/blob/main/Releases.md"><img src="https://img.shields.io/badge/deno-^1.8.1-brightgreen?logo=deno" alt="Minimum supported Deno version" /></a>
...
```ts
import { watch } from "https://deno.land/x/drollup@2.41.0+0.16.1/mod.ts";
...
1. Run the deno-rollup `helloDeno` example directly from the repository:
   ...
   ```console
   deno run --allow-read="./" --allow-write="./dist" --allow-net="deno.land" --allow-env --unstable https://deno.land/x/drollup@2.41.0+0.16.1/examples/helloDeno/rollup.build.ts
   ```
