...
deno run --allow-read --allow-write --allow-net --allow-env --allow-run --unstable --no-check https://deno.land/x/drollup@2.58.0+0.20.0/examples/esbuild/rollup.build.ts
...
```console
# Direct from repository
deno run --allow-read --allow-write --allow-net --allow-env --allow-run --unstable --no-check https://deno.land/x/drollup@2.58.0+0.20.0/examples/esbuild/rollup.watch.ts
