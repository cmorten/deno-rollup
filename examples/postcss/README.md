...
deno run --allow-read="./" --allow-write="./dist" --allow-net="deno.land" --allow-env --unstable https://deno.land/x/drollup@2.39.1+0.15.0/examples/postcss/rollup.build.ts
...
```console
deno run --allow-net --allow-read https://deno.land/std@0.89.0/http/file_server.ts ./dist --port 3000
```
...
```console
deno install -f -q --allow-read --allow-write --allow-net --allow-env --unstable https://deno.land/x/drollup@2.39.1+0.15.0/rollup.ts
```
...
```console
# Direct from repository
deno run --allow-read="./" --allow-write="./dist" --allow-net="deno.land" --allow-env --unstable https://deno.land/x/drollup@2.39.1+0.15.0/examples/postcss/rollup.watch.ts
