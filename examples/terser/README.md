...
deno run --allow-read --allow-write="./dist" --allow-net --allow-env --unstable --no-check https://deno.land/x/drollup@2.52.7+0.19.1/examples/terser/rollup.build.ts
...
```console
# Direct from repository
deno run --allow-read --allow-write="./dist" --allow-net --allow-env --unstable --no-check https://deno.land/x/drollup@2.52.7+0.19.1/examples/terser/rollup.watch.ts
